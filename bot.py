...
def updateAuto(client, message,redis):
    ...
    if group is True and redis.get("{}Nbot:autoaddbot".format(BOT_ID)):
        ...
        if not redis.sismember("{}Nbot:disabledgroups".format(BOT_ID),chatID):
            ...
            kb = InlineKeyboardMarkup([[InlineKeyboardButton(r.MoreInfo, url="t.me/ccqli")]])
            ...
            get = (redis.hget("{}Nbot:links".format(BOT_ID),chatID) or GetLink(chatID) or "https://t.me/ccqli")
